...
public abstract class Hechizo {
	...
	public String toString() {
		return this.getClass().getSimpleName() + " " + nombre + " lanzada " + "el " + fechaLanzamiento.getDayOfMonth() + " del " + fechaLanzamiento.getMonthValue() + " de " + fechaLanzamiento.getYear() + " consumiendo " + puntos + " puntos.";
	}
}